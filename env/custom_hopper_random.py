...
class CustomHopper(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, domain=None, flag=1):
    ...
    def sample_parameters(self):
        ...
        # Sample the values of masses from the uniform distributions
        masses = self.sim.model.body_mass[1:]
        masses[1] = np.random.uniform(max_min1[0], max_min2[1])
        masses[2] = np.random.uniform(max_min2[0], max_min2[1])
        masses[3] = np.random.uniform(max_min3[0], max_min3[1])
